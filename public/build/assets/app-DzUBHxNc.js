            ...
            h.push(u),
                a.forEach(u, function (E, x) {
                    (!(a.isUndefined(E) || E === null) &&
                        s.call(t, E, a.isString(x) ? x.trim() : x, m, w)) ===
...
let A = class {
    ...
    set(t, n, r) {
        ...
        else if (a.isString(t) && (t = t.trim()) && !En(t)) o(wn(t), n);
...
const at = (e) => {
    ...
    Un = async function* (e, t) {
        for await (const n of kn(e)) yield* Ln(n, t);
    },
    kn = async function* (e) {
        ...
        return async (u) => {
            ...
            try {
                ...
                if (l && (N || (Ae && B))) {
                    ...
                    const H = a.toFiniteNumber(L.headers.get("content-length")),
                        [le, Q] = (N && Le(H, ne(Ue(N), !0))) || [];
                    L = new r(
                        Be(L.body, De, le, () => {
                            Q && Q(), B && B();
                        }),
                ...
                C = C || "text";
                let pt = await h[a.findKey(h, C) || "text"](L, u);
                return (
                    !Ae && B && B(),
...
b.mergeConfig = q;
b.AxiosHeaders = A;
b.formToJSON = (e) => rt(a.isHTMLForm(e) ? new FormData(e) : e);
b.getAdapter = lt.getAdapter;
b.HttpStatusCode = we;
b.default = b;
const {
    Axios: Vn,
...
document.addEventListener("livewire:init", () => {
    Livewire.on("trigger-download", (e) => {
        const { url: t, filename: n } = e[0],
        ...
        (r.href = t),
            ...
            setTimeout(() => {
                Livewire.dispatch("success_flash", {
                    message: "File is downloading.",
                });
            }, 100);
    }),
        Livewire.on("trigger-folder-download", (e) => {
            const { url: t, foldername: n } = e[0],
                r = document.createElement("a");
            (r.href = t),
                (r.download = n + ".zip"),
                (r.style.display = "none"),
                ...
                setTimeout(() => {
                    Livewire.dispatch("success_flash", {
                        message: "Folder is being prepared for download.",
                    });
                }, 100);
        });
});
