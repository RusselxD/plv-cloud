<div x-data="{ show: false, message: '' }" x-on:success_flash.window="
        show = true; 
    ...
    class="z-50 max-w-96 text-sm fixed top-5 right-5 px-6 text-white py-3 rounded-xl bg-green-600 border-2 border-green-300 shadow-lg"
    x-text="message"></div>