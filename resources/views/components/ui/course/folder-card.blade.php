...
<div class="border border-gray-600 w-full rounded-lg cursor-pointer hover:shadow-md">
     ...
     <div class="flex items-center justify-between px-2 py-[0.40rem] border-t border-gray-600 text-sm">
          <a href="{{ route('user', ['username' => $folder->user->username]) }}"
               class="flex items-center justify-start gap-2 rounded-sm group">
