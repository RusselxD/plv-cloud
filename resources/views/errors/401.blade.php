        ...
        <div class="bg-slate-100 rounded-lg p-8 md:p-12 shadow-lg max-w-2xl w-full text-center">
            ...
            <div class="flex justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M2 8c0-2.2.7-4 2-5" />
                    <path d="M22 8c0-2.2-.7-4-2-5" />
                </svg>
            </div>

            <!-- Error Code -->
            <h1 class="text-6xl md:text-8xl font-bold text-primary mb-4">401</h1>

            <!-- Error Message -->
            <h2 class="text-2xl md:text-3xl font-semibold text-gray-800 mb-3">Unauthorized</h2>
